...
Personal QMK firmware configuration for my ZSA Moonlander keyboard. This layout, named "reverie", features custom RGB matrix effects, tap dance functions, and multi-layer functionality optimized for productivity and coding.

## Agent Documentation

For agents working on this codebase, see [AGENTS.md](AGENTS.md) for detailed information about the project structure, build commands, code patterns, and important considerations.

---

# Building the layout from source

*The following section was auto-generated by the ZSA Oryx configurator when exporting the layout source code.*
